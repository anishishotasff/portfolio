...
export enum SkillNames {
  ...
  LINUX_WINDOWS_SECURITY = "linux_windows_security",
  CSRF = "csrf",
}
export type Skill = {
  id: number;
...
using use = useUsing("use")`,
  ...
  [SkillNames.NETWORK_SECURITY]: {
    id: 26,
    name: "network_security",
    label: "Network Security",
    shortDescription: "Protecting networks from threats and vulnerabilities 🔒🌐",
    color: "#ff6b6b",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg",
  },
  [SkillNames.NMAP]: {
    ...
    name: "nmap",
    label: "Nmap",
    shortDescription: "Network scanning and security auditing tool 🔍🛡️",
    color: "#4a90e2",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg",
  },
  [SkillNames.SQL_INJECTION]: {
    id: 28,
    name: "sql_injection",
    label: "SQL Injection",
    shortDescription: "Understanding and preventing SQL injection attacks 💉🛡️",
    color: "#e74c3c",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg",
  },
  [SkillNames.WIRESHARK]: {
    ...
    name: "wireshark",
    label: "Wireshark",
    shortDescription: "Network protocol analyzer for packet inspection 🦈📡",
    color: "#1679a7",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg",
  },
  [SkillNames.KALI_LINUX]: {
    id: 30,
    name: "kali_linux",
    label: "Kali Linux",
    shortDescription: "Penetration testing and security auditing platform 🐉💻",
    color: "#367bf5",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg",
  },
  [SkillNames.BURP_SUITE]: {
    id: 31,
    name: "burp_suite",
    label: "Burp Suite",
    shortDescription: "Web application security testing toolkit 🔧🔐",
    color: "#ff6633",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firefox/firefox-original.svg",
  },
  [SkillNames.LINUX_WINDOWS_SECURITY]: {
    id: 32,
    name: "linux_windows_security",
    label: "Linux & Windows Security",
    shortDescription: "Securing both Linux and Windows systems 🐧🪟",
    color: "#0078d4",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg",
  },
  [SkillNames.CSRF]: {
    ...
    shortDescription: "Understanding and preventing CSRF attacks 🎯🛡️",
    color: "#f39c12",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firefox/firefox-original.svg",
  },
};
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Self-emlpoyed",
    description: [
      "Built full-stack e-commerce and dynamic web applications.",
      "Architected async job queues processing 1k+ AI tasks daily with bulletproof reliability.",
      "Developed responsive websites with APIs and database integration.",
      "Managed end-to-end development, deployment, and maintenance.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.TS,
  ...
  },
  {
    ...
    description: [
      "Certified Ethical Hacker trained by Edureka with hands-on practical experience.",
      "Skilled in penetration testing, vulnerability assessment, and basic cybersecurity tools.",
      "Automated repetitive processes, improving efficiency and reducing human error.",
      "Knowledge of web security, network security, and ethical hacking methodologies.",
    ],
    skills: [
      SkillNames.NETWORK_SECURITY,
      SkillNames.NMAP,
